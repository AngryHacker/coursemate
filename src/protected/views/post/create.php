...
?>
       ...
       <div class='container'>
             <ul class='nav nav-pills nav-justified tabs' role='tablist'>
                <li role='presentation' class="text-center">
                    <a href="?r=course/index"><span class="glyphicon glyphicon-hand-right"></span> 返回</a></li>
                <li role='presentation' class="text-center">
    ...
    <div class="content" data-role='content'>
      ...
      <div class="panel panel-warning">
          <div class="panel-heading text-center"><center style='font-size:15px;font-weight:650;'>主题： <?php echo $topic;?></center></div>
