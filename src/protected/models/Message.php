...
class Message extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fr_id, content, send_time', 'required'),
			array('fr_id, send_time', 'numerical', 'integerOnly'=>true),
			array('content', 'length', 'max'=>1024),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('me_id, fr_id, content, send_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fr' => array(self::BELONGS_TO, 'Friend', 'fr_id'),
		);
	}
